...
import firstMod.patches.relics.BottledPlaceholderField;
import firstMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static firstMod.DefaultMod.makeRelicOutlinePath;
import static firstMod.DefaultMod.makeRelicPath;
